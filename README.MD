...
- Entre no gitthub e crie novo repositório :  https://github.com/palomapaldino5/sincode.git
- Usar commitespecificando a tarefa commit -m "<<codigo-task>> <<mensagem>> <<#status>>"